 ...
 * @version 1.0
 * @author： WangQiMin
 * @date： 2022-09-15 09:48
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "accessories_operation")
@ApiModel(value = "辅料仓库", description = "辅料仓库实体类")
public class AccessoriesOperation {
    ...
    @TableField(exist = false)
    private List<AccessoriesPurchase> accessoriesPurchaseList;
