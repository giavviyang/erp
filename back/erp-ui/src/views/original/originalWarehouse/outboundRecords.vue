  ...
  data(){
    return{
      ...
      tableColumn: [
        ...
        {label: '出库数量（片）', prop: 'originalNum', width: '120'},
        {label: '出库面积（m²）', prop: 'originalArea', width: '120'},
        {label: '出库金额（元）', prop: 'totalAmount', width: '120'},
        {label: '领料人', prop: 'person', width: '100'},
        {label: '出库日期', prop: 'operationDate', width: '120'},
        {label: '备注', prop: 'remarks', width: '100'},
      ],
      //总合计
      summation: [
        {label: 'originalNum', title: '出库总数量', value: 0, unit: '片'},
        {label: 'originalArea', title: '出库总面积', value: 0, unit: 'm²'},
      ...
      detailDialogColumns: [
        ...
        {label: '出库数量（片）', prop: 'operationNum', width: '100'},
        {label: '出库单价（元/m²）', prop: 'operationPrice', width: '120'},
        {label: '出库面积（m²）', prop: 'operationArea', width: '100'},
      ],
    }
  },
  created() {
