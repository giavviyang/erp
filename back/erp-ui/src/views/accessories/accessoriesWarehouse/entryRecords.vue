  ...
  <div class="app-container-padding">
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" class="iptAndBtn" style="position: relative">
      <div style="white-space: nowrap;margin-right: 90px;">
        ...
        <el-form-item label="负责人" prop="purchaseNo">
          <el-input
  ...
  data(){
    return{
      ...
      tableColumn: [
        ...
        {label: '入库数量', prop: 'originalNum', width: '120'},
        {label: '入库金额（元）', prop: 'totalAmount', width: '120'},
        {label: '负责人', prop: 'person', width: '100'},
        {label: '入库日期', prop: 'operationDate', width: '180'},
        {label: '备注', prop: 'remarks', width: '100'},
      ],
      //总合计
      summation: [
        {label: 'originalNum', title: '入库总数量', value: 0,},
      ...
      detailDialogColumns: [
        ...
        {label: '入库数量', prop: 'operationNum', width: '120'},
        {label: '入库单价（元/m²）', prop: 'operationPrice', width: '150'},
      ],
    }
  },
  created() {
